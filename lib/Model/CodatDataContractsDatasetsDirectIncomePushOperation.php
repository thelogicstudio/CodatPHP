...
/**
 * CodatDataContractsDatasetsDirectIncomePushOperation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsDirectIncomePushOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.DirectIncomePushOperation';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsDirectIncome',
        'data_type' => 'string',
        'company_id' => 'string',
    ...
    */
     ...
     * Sets data
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsDirectIncome|null $data data
     *
     * @return self
     */
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CodatDataContractsDatasetsDirectIncomePushOperation., must be bigger than or equal to 1.');
        }
