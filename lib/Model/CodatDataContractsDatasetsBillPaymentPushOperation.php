...
/**
 * CodatDataContractsDatasetsBillPaymentPushOperation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsBillPaymentPushOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.BillPaymentPushOperation';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsBillPayment',
        'data_type' => 'string',
        'company_id' => 'string',
    ...
    */
     ...
     * Sets data
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsBillPayment|null $data data
     *
     * @return self
     */
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CodatDataContractsDatasetsBillPaymentPushOperation., must be bigger than or equal to 1.');
        }
