...
/**
 * CodatDataContractsDatasetsCommerceProductCategory Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsCommerceProductCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.Commerce.ProductCategory';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'ancestor_refs' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsCommerceAncestorRef[]',
        'has_children' => 'bool',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ancestor_refs', $data ?? [], null);
    ...
    */
     ...
     * Gets ancestor_refs
     *
     * @return \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsCommerceAncestorRef[]|null
     */
    public function getAncestorRefs()
    {
        return $this->container['ancestor_refs'];
    }

    /**
     * Sets ancestor_refs
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsCommerceAncestorRef[]|null $ancestor_refs ancestor_refs
     *
     * @return self
     */
    public function setAncestorRefs($ancestor_refs)
    {
        if (is_null($ancestor_refs)) {
            array_push($this->openAPINullablesSetToNull, 'ancestor_refs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ancestor_refs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ancestor_refs'] = $ancestor_refs;
