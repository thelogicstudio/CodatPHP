...
/**
 * CodatDataContractsDatasetsItemPushOperation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsItemPushOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.ItemPushOperation';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsItem',
        'data_type' => 'string',
        'company_id' => 'string',
    ...
    */
     ...
     * Sets data
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsItem|null $data data
     *
     * @return self
     */
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CodatDataContractsDatasetsItemPushOperation., must be bigger than or equal to 1.');
        }
