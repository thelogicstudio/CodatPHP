...
/**
 * CodatDataContractsDatasetsBillCreditNotePushOperation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsBillCreditNotePushOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.BillCreditNotePushOperation';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsBillCreditNote',
        'data_type' => 'string',
        'company_id' => 'string',
    ...
    */
     ...
     * Sets data
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsBillCreditNote|null $data data
     *
     * @return self
     */
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CodatDataContractsDatasetsBillCreditNotePushOperation., must be bigger than or equal to 1.');
        }
