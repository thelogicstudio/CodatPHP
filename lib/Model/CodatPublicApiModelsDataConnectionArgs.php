...
/**
 * CodatPublicApiModelsDataConnectionArgs Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatPublicApiModelsDataConnectionArgs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.Public.Api.Models.DataConnectionArgs';
    ...
    */
    ...
    public function setPlatformKey($platform_key)
    {
        if (is_null($platform_key)) {
            array_push($this->openAPINullablesSetToNull, 'platform_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('platform_key', $nullablesSetToNull);
            if ($index !== FALSE) {
