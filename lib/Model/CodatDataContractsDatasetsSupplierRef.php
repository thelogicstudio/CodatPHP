...
/**
 * CodatDataContractsDatasetsSupplierRef Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsSupplierRef implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.SupplierRef';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CodatDataContractsDatasetsSupplierRef., must be bigger than or equal to 1.');
        }
