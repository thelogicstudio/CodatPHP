...
/**
 * CodatDataContractsDatasetsSalesOrder Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsSalesOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.SalesOrder';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSalesOrderStatus',
        'invoicing_status' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsInvoicingStatus',
        'currency' => 'string',
        'currency_rate' => 'float',
        'line_items' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSalesOrderLineItem[]',
    ...
    */
    ...
    public function setSalesOrderNumber($sales_order_number)
    {
        if (is_null($sales_order_number)) {
            array_push($this->openAPINullablesSetToNull, 'sales_order_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sales_order_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setCustomerPurchaseOrderNumber($customer_purchase_order_number)
    {
        if (is_null($customer_purchase_order_number)) {
            array_push($this->openAPINullablesSetToNull, 'customer_purchase_order_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_purchase_order_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets status
     *
     * @return \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSalesOrderStatus|null
     */
     ...
     * Sets status
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSalesOrderStatus|null $status status
     *
     * @return self
     */
     ...
     *
     * @return \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsInvoicingStatus|null
     */
     ...
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsInvoicingStatus|null $invoicing_status invoicing_status
     *
     * @return self
     */
     ...
     * Gets line_items
     *
     * @return \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSalesOrderLineItem[]|null
     */
     ...
     * Sets line_items
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSalesOrderLineItem[]|null $line_items line_items
     *
     * @return self
     */
