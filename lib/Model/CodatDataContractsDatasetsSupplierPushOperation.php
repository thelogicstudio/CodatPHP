...
/**
 * CodatDataContractsDatasetsSupplierPushOperation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsSupplierPushOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.SupplierPushOperation';
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSupplier',
        'data_type' => 'string',
        'company_id' => 'string',
    ...
    */
     ...
     * Sets data
     *
     * @param \TheLogicStudio\CodatPHP\Model\CodatDataContractsDatasetsSupplier|null $data data
     *
     * @return self
     */
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CodatDataContractsDatasetsSupplierPushOperation., must be bigger than or equal to 1.');
        }
