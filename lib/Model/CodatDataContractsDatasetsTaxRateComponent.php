...
/**
 * CodatDataContractsDatasetsTaxRateComponent Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataContractsDatasetsTaxRateComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataContracts.Datasets.TaxRateComponent';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_compound', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_compound'] === null) {
            $invalidProperties[] = "'is_compound' can't be null";
        }
     ...
     * Sets is_compound
     *
     * @param bool $is_compound is_compound
     *
     * @return self
     */
    public function setIsCompound($is_compound)
    {
        if (is_null($is_compound)) {
            throw new \InvalidArgumentException('non-nullable is_compound cannot be null');
        }
