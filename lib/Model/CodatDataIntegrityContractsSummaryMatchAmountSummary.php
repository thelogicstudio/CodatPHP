...
/**
 * CodatDataIntegrityContractsSummaryMatchAmountSummary Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatDataIntegrityContractsSummaryMatchAmountSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.DataIntegrity.Contracts.Summary.MatchAmountSummary';
    ...
    {
        $this->setIfExists('match_percentage', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $match_percentage match_percentage
     *
     * @return self
     */
    public function setMatchPercentage($match_percentage)
    {
        if (is_null($match_percentage)) {
            throw new \InvalidArgumentException('non-nullable match_percentage cannot be null');
        }
     ...
     * Sets unmatched
     *
     * @param float|null $unmatched unmatched
     *
     * @return self
     */
     ...
     * Sets matched
     *
     * @param float|null $matched matched
     *
     * @return self
     */
