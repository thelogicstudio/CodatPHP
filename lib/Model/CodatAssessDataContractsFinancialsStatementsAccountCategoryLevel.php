...
/**
 * CodatAssessDataContractsFinancialsStatementsAccountCategoryLevel Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\CodatPHP
 * @author   OpenAPI Generator team
 ...
 */
class CodatAssessDataContractsFinancialsStatementsAccountCategoryLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Codat.Assess.DataContracts.Financials.Statements.AccountCategoryLevel';
    ...
    */
    ...
    public function setLevelName($level_name)
    {
        if (is_null($level_name)) {
            array_push($this->openAPINullablesSetToNull, 'level_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('level_name', $nullablesSetToNull);
            if ($index !== FALSE) {
